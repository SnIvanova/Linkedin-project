        ...
        <Container>
            {userMe &&
                <Card className='rounded-5'>
                    ...
                    <Card.Text className='ps-4 py-2 border-top'><BookmarkFill className='text-secondary fs-1 pe-3 ' />My Items</Card.Text>
                </Card>}
                ...
                <Card.Body className='p-0'>
                    <Accordion defaultActiveKey={['0']} alwaysOpen flush>
                        ...
                        <Accordion.Header>Recents</Accordion.Header>
                            <Accordion.Body>
                                <Card.Text className='text-truncate m-0'><FaPeopleGroup /> Artificial Intelligence, Machine Learning, Data Science & Robotics',</Card.Text>
                                <Card.Text className='text-truncate m-0'><FaPeopleGroup /> Developers, Engineers & Techies: Solidity, Rust, C++, C#, Python, Java, Javascript | Blockchain</Card.Text>
                                <Card.Text className='text-truncate m-0'><FaPeopleGroup /> User Experience Design (UX)</Card.Text>
                            </Accordion.Body>
                        </Accordion.Item>
                    ...
                    <Card.Link className='px-4 my-3 d-flex justify-content-between align-items-center'>Events <FiPlus className=' fs-5'/></Card.Link>
